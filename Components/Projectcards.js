      ...
      <Element id="Projects" name="Projects">
           <div className="flex-col justify-start text-center mx-5 md:mx-6 lg:mx-8 py-44 space-y-40">
                ...
                <div className="flex flex-col justify-between md:ml-6 lg:ml-8"> 
                 ...
                 <p className="flex mt-0 justify-start text-left text-xl lg:text-2xl break-normal text-zinc-400">Designing a seamless experience to leverage QR codes—built on the Solana blockchain.</p>
                ...
                <div className="flex flex-col justify-between md:ml-6 lg:ml-8"> 
                 ...
                 <p className="flex mt-0 justify-start text-left text-xl lg:text-2xl break-normal text-zinc-400">Helping beauty professionals better engage clients within a new, digital space.</p>
                  <div className="mt-10 md:mt-52 lg:mt-48 text-left">
                ...
                <div className="flex flex-col justify-between md:ml-6 lg:ml-8"> 
                 ...
                 <p className="flex mt-0 justify-start text-left text-xl lg:text-2xl break-normal text-zinc-400">Redesigning a digital platform, exclusively for beauty professionals.</p>
                  <div className="mt-10 md:mt-52 lg:mt-48 text-left">
