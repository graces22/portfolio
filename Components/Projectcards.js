      ...
      <Element id="Projects" name="Projects">
           ...
           <div className="flex-col md:flex md:flex-row justify-between md:space-x-7">
                 <div className="w-full md:w-2/3 md:flex-1">
                  <a href="/canadalife"><Image src={CLhero} alt="hero" layout="responsive" objectFit="cover" className="p-2 cursor-pointer transition ease-in-out delay-100 hover:scale-105 duration-500"/></a>
                 </div>
                 <div className="md:flex flex-col w-full md:w-1/3 md:ml-6 lg:ml-8 justify-between">   
                   <div className="mt-5 md:mt-0 space-y-4">
                     
                      <a href="/canadalife" className="flex font-normal text-left text-4xl lg:text-5xl cursor-pointer">Canada Life</a>
          
                    <div className="w-full border-t border-black border-dotted"></div>
                    <p className="flex mt-0 text-left text-lg lg:text-xl break-normal">A homepage refresh now better tailored to both new and existing clients.</p>
                   </div>
                  <div className="mt-14 md:mt-0 space-y-4">
                   <p className="font-normal text-xs md:text-sm text-left tracking-wider">RESPONSIVE WEB · REDESIGN · CASE STUDY</p>
                      <div className="w-full border-t border-black border-dotted"></div>
                  </div>
                </div>
            </div>
