export const projects = {
   tapqr: {
       ...
       h1: "Project Type",
       list1: [ "Desktop web", "Mobile app", "Case study", ],
       h2: "Project Timeline",
   ...
   saloneverywhere: {
       ...
       overview: "SalonEverywhere is an emerging startup within the beauty industry, striving to embrace our ever-changing environment through digital innovation. This is essential to professionals today amidst the global pandemic, in which they need to rebuild their client book and grow their business in ways that exceeded current practices.",
       h1: "Project Type",
       list1: [ "Redesign", "Responsive web", "Case study", ],
       h2: "Project Timeline",
